    ...
    <div className="space-y-4">
      ...
      <Field label="Initial Balance">
        <div className="flex items-center gap-2">
          <StepButton onClick={() => update("initialBalance", stepDown(account.initialBalance))} className="w-7 h-7 flex items-center justify-center rounded-lg border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 select-none text-sm font-medium transition-colors">−</StepButton>
          <CurrencyInput
          ...
          />
          <StepButton onClick={() => update("initialBalance", stepUp(account.initialBalance))} className="w-7 h-7 flex items-center justify-center rounded-lg border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 select-none text-sm font-medium transition-colors">+</StepButton>
        </div>
      </Field>
